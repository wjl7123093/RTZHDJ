...
@ActivityScope
public class VolunteerServicePresenter extends BasePresenter<VolunteerServiceContract.Model, VolunteerServiceContract.View>
    implements VolunteerServiceContract.Presenter {
    private RxErrorHandler mErrorHandler;
    private Application mApplication;
    private ImageLoader mImageLoader;
    private AppManager mAppManager;

    private VolunteerServiceActivity mActivity;

    @Inject
    public VolunteerServicePresenter(VolunteerServiceContract.Model model, VolunteerServiceContract.View rootView
    ...
    @Override
    public void setActivity(VolunteerServiceActivity activity) {
        mActivity = activity;
    }
