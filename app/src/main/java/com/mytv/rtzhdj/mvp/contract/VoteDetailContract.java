...
public interface VoteDetailContract {
    ...
    interface View extends IView {
        void loadData(List<VoteDetailEntity> voteDetailList, boolean update);
    }
    ...
    interface Model extends IModel {
        ...
        // 获取我要投票详情
        Observable<BaseJson<List<VoteDetailEntity>>> getVoteOptionsList(int id, int userId, boolean update);
    ...
    interface Presenter extends IPresenter {
        ...
        // 调用 获取我要投票详情
        void callMethodOfGetVoteOptionsList(int id, int userId, boolean update);
    }
}
