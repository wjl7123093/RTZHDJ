...
@ActivityScope
public class ElectiveCoursePresenter extends BasePresenter<ElectiveCourseContract.Model, ElectiveCourseContract.View>
    implements ElectiveCourseContract.Presenter {
    ...
    @Inject
    public ElectiveCoursePresenter(ElectiveCourseContract.Model model, ElectiveCourseContract.View rootView
