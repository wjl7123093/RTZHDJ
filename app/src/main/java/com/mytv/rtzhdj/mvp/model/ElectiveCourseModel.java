...
@ActivityScope
public class ElectiveCourseModel extends BaseModel implements ElectiveCourseContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public ElectiveCourseModel(IRepositoryManager repositoryManager, Gson gson, Application application) {
