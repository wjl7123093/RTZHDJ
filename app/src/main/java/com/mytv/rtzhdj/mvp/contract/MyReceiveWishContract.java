...
public interface MyReceiveWishContract {
    ...
    interface Model extends IModel {
        ...
        // 获取 我的心愿数据
        Observable<BaseJson<List<MyWishEntity>>> postMyClaimWishList(int userId, int type, boolean update);
    ...
    interface Presenter extends IPresenter {
        void setActivity(MyReceiveWishActivity activity);
        //初始化 RecyclerView
        RecyclerView initRecyclerView(RecyclerView recyclerView);

        // 调用 获取我认领的心愿API
        void callMethodOfPostMyClaimWishList(int userId, int type, boolean update);
