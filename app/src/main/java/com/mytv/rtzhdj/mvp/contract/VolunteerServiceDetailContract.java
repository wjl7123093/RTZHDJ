...
public interface VolunteerServiceDetailContract {
    ...
    interface Model extends IModel {
        ...
        // 获取 志愿服务详情
        Observable<BaseJson<VolunteerDetailEntity>> getVolunteerServiceDetail(int id, boolean update);
    ...
    interface Presenter extends IPresenter {
        ...
        // 调用 获取志愿服务详情数据
        void callMethodOfGetVolunteerServiceDetail(int id, boolean update);
    }
}
