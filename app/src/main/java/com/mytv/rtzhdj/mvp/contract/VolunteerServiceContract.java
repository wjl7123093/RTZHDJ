...
public interface VolunteerServiceContract {
    //对于经常使用的关于UI的方法可以定义到IView中,如显示隐藏进度条,和显示文字消息
    interface View extends IView {
        void loadData(List<VoluteerServiceEntity> volunteerServiceList, boolean udpate);
    }
    ...
    interface Presenter extends IPresenter {
        void setActivity(VolunteerServiceActivity activity);
        //初始化 RecyclerView
