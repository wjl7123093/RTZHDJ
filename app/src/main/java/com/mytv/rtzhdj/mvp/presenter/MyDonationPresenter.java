...
@ActivityScope
public class MyDonationPresenter extends BasePresenter<MyDonationContract.Model, MyDonationContract.View>
    implements MyDonationContract.Presenter {
    private RxErrorHandler mErrorHandler;
    private Application mApplication;
    private ImageLoader mImageLoader;
    private AppManager mAppManager;

    private MyDonationActivity mActivity;

    @Inject
    public MyDonationPresenter(MyDonationContract.Model model, MyDonationContract.View rootView
    ...
    @Override
    public void setActivity(MyDonationActivity activity) {
        mActivity = activity;
    }
