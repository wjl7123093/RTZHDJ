...
public class ContentModel extends BaseModel implements ContentContract.Model {
    ...
    @Override
    public Observable<BaseJson<PartyRecommendEntity>> getPartyRecommend(int currentSystemId, int pageIndex, int pageSize, boolean update) {
        return mRepositoryManager.obtainRetrofitService(ContentService.class)
                .getPartyRecommend(currentSystemId, pageIndex, pageSize);
    }
