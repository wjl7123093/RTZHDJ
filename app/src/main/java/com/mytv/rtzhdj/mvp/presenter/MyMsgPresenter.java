...
@ActivityScope
public class MyMsgPresenter extends BasePresenter<MyMsgContract.Model, MyMsgContract.View>
    implements MyMsgContract.Presenter {
    private RxErrorHandler mErrorHandler;
    private Application mApplication;
    private ImageLoader mImageLoader;
    private AppManager mAppManager;

    private MyMsgActivity mActivity;

    @Inject
    public MyMsgPresenter(MyMsgContract.Model model, MyMsgContract.View rootView
    ...
    @Override
    public void setActivity(MyMsgActivity activity) {
        mActivity = activity;
    }
    ...
    public void callMethodOfPostMyMessage(@NonNull int userId, @NonNull int messageType,
        ...
        mModel.postMyMessage(userId, messageType, pageIndex, pageSize, update)
                ...
                .subscribe(new ErrorHandleSubscriber<BaseJson<List<MyMsgEntity>>>(mErrorHandler) {
                    @Override
