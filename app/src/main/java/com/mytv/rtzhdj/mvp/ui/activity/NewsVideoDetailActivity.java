 ...
 * @update
 */
@Route(path = ARoutePath.PATH_NEWS_VIDEO_DETAIL)
public class NewsVideoDetailActivity extends BaseActivity<NewsVideoDetailPresenter> implements NewsVideoDetailContract.View {
    ...
    public void setupActivityComponent(AppComponent appComponent) {
        DaggerNewsVideoDetailComponent //如找不到该类,请编译一下项目
                .builder()
                .appComponent(appComponent)
                .newsVideoDetailModule(new NewsVideoDetailModule(this))
                .build()
                .inject(this);
    }
    ...
    public int initView(Bundle savedInstanceState) {
        return R.layout.activity_news_video_detail; //如果你不需要框架帮你设置 setContentView(id) 需要自行设置,请返回 0
    }
...
//        String url =  "http://devimages.apple.com.edgekey.net/streaming/examples/bipbop_4x3/bipbop_4x3_variant.m3u8";
    ...
    private void resolveNormalVideoUI() {
        ...
        detailPlayer.getBackButton().setOnClickListener(view -> killMyself());
    }
