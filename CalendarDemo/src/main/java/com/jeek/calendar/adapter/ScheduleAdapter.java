...
public class ScheduleAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof ScheduleViewHolder) {
            ...
            viewHolder.tvScheduleDelete.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
    ...
    protected class ScheduleViewHolder extends RecyclerView.ViewHolder {
        ...
        protected TextView tvScheduleDelete;
        ...
        public ScheduleViewHolder(View itemView) {
            ...
            tvScheduleDelete = (TextView) itemView.findViewById(R.id.tvDelete);
        }
